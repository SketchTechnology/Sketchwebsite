...
const SocialBtn = () => {
  const whatsappUrl = `https://wa.me/+971564093626`;


  return (
    <div className="tooltip-container contactUsBtn">
    <span className="text">
      <svg
    ...
    <Nav.Link href='https://twitter.com/SKETCH864181451' target='_blank' >
    ...
    <Nav.Link href='https://www.facebook.com/usesketch/' target='_blank'>
    ...
    <Nav.Link href={whatsappUrl} rel="noopener noreferrer" target="_blank">
