    ...
    <div className=" CreativeAgencParent ">
      <div className="container mx-auto ">
        <div className="headings  d-flex flex-column align-items-center  ">
          ...
          <h2 className="text-dark">Increase Your Web Traffic with Our Experts</h2>
        </div>
        <div className="row gap-3">
            <div className="col-12 p-0 col-md-4 position-relative badgeimg">
                <img src={img1} alt="person" />
            </div>
            <div className="col p-0 col-md-7  position-relative badgeimg">
      ...
      <div className="bi-fun-fact-counter container mx-auto">
                ...
                <p className="text-center">No matter how big your company is, as you expand and reach new highs you’ll want an agency to
