    ...
    return (
        <div className="full-width-slider bg-white position-relative logoSlider ">
            <div className="OurClientsLogo d-flex justify-content-center align-items-center">
                <h2 className='d-flex justify-content-center align-items-center logoSliderTitle shadow text-white  '>Our Clients</h2>
            ...
            >
                <Slider.Slide>
                <LazyLoadingImage src={img1} alt={"iLawFair"}  height={'100px'}   />
                </Slider.Slide>           
                <Slider.Slide>
                <LazyLoadingImage src={img2} alt={"Babak"}     height={'100px'}     />
                </Slider.Slide>           
                <Slider.Slide>
                <LazyLoadingImage src={img3} alt={"IlawServ"}  height={'100px'}     />
                </Slider.Slide>           
                <Slider.Slide>
                <LazyLoadingImage src={img4} alt={"Bonbon"}   height={'100px'}    />
                </Slider.Slide>           
                <Slider.Slide>
                <LazyLoadingImage src={img5} alt={"اقرب"}     height={'100px'}     />
                </Slider.Slide>           
                <Slider.Slide>
                <LazyLoadingImage src={img6} alt={"enaya"}    height={'100px'}     />
                </Slider.Slide>           
                <Slider.Slide>
                <LazyLoadingImage src={img7} alt={"lulu"}    height={'100px'}    />
                </Slider.Slide>           
